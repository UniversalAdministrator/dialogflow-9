...
function getTeamSchedule(req,res)
    ...
    let parameters = req.body.result.parameters;
        if (parameters.team1 == "")
        {
          ...
          {
            return res.json({
                speech: 'Last game between Kings and '+parameters.team+' was played on yesterday .Kings won this match by 1 goal',
                displayText: 'Last game between Kings and '+parameters.team+' was played on yesterday .Kings won this match by 1 goal',
